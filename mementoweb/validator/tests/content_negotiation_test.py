...
class ContentNegotiationTest(BaseTest):
    ...
    def test(self, connection: HttpConnection) -> TestReport:
        ...
        try:
            ...
            self.add_test_result(TestResult(description=ContentNegotiationTest.CONTENT_NEGOTIATION_HEADERS_PRESENT))
        except HeadersNotFoundError:
            self.add_test_result(TestResult(description=ContentNegotiationTest.HEADERS_NOT_PRESENT))
        except HeaderTypeNotFoundError:
            self.add_test_result(TestResult(description=ContentNegotiationTest.CONTENT_NEGOTIATION_HEADERS_NOT_PRESENT))
